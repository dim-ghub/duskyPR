...
pkgs_filesystem=(
	"btrfs-progs" "compsize" "zram-generator" "udisks2" "udiskie" "dosfstools" "ntfs-3g" "gvfs" "gvfs-mtp" "gvfs-nfs" "gvfs-smb" "xdg-user-dirs" "usbutils" "gnome-disk-utility" "unzip" "zip" "unrar" "7zip" "cpio" "file-roller" "rsync" "nemo" "nemo-fileroller" "tumbler" "ffmpegthumbnailer" "webp-pixbuf-loader" "poppler-glib"
)
